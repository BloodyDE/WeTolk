    ...
    class Meta:
        ...
        widgets = {
            "creator_name": forms.TextInput(attrs={
                "placeholder": "Name eintragen – leer lassen für „Anonym“",
...
class CommentForm(forms.ModelForm):
    author_name = forms.CharField(
        ...
        max_length=100,
        strip=True,
        help_text="Leer lassen = Anonym",
        widget=forms.TextInput(attrs={
            "placeholder": "Dein Name (Leer lassen für Anonym)",
    ...
    def clean_creator_name(self):
        v = (self.cleaned_data.get("creator_name") or "").strip()
        return v or "Anonym"